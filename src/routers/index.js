...
const transcriptionRouter = require("./routers/transcription");
...
router.use("/transcription-audio", transcriptionAudioRouter); // http://localhost:3003/api/transcription-audio
